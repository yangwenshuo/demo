						  ...
						  <#list specificationList as spec>
							<dl>
								...
								<#list spec.attributeValue as attrvalue>
									<dd><a ng-click="selectSpecification('${spec.attributeName}','${attrvalue}')"  class="{{isSelected('${spec.attributeName}','${attrvalue}')?'selected':''}}">${attrvalue}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
						  </#list>
						</div>
